...
pub const wl_display_error = u32;
...
pub const wl_keyboard_key_state = u32;
...
pub const wl_keyboard_keymap_format = u32;
...
pub const wl_output_transform = u32;
...
pub const wl_pointer_error = u32;
pub const WL_POINTER_ERROR_ROLE: wl_pointer_error = 0;

pub const wl_seat_capability = u32;
...
pub const wl_shell_error = u32;
pub const WL_SHELL_ERROR_ROLE: wl_shell_error = 0;

pub const wl_shell_surface_fullscreen_method = u32;
...
pub const wl_shell_surface_resize = u32;
...
pub const wl_subcompositor_error = u32;
pub const WL_SUBCOMPOSITOR_ERROR_BAD_SURFACE: wl_subcompositor_error = 0;

pub const wl_subsurface_error = u32;
