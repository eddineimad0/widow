//! Bindings for OpenGL 4.6 (Core profile) generated by zigglgen.
...
pub fn BindBuffersBase(target: @"enum", first: uint, count: sizei, buffers: [*c]const uint) void {
    return ProcTable.current.?.BindBuffersBase(target, first, count, buffers);
}
pub fn BindBuffersRange(target: @"enum", first: uint, count: sizei, buffers: [*c]const uint, offsets: [*c]const intptr, sizes: [*c]const sizeiptr) void {
...
pub fn BindVertexBuffers(first: uint, count: sizei, buffers: [*c]const uint, offsets: [*c]const intptr, strides: [*c]const sizei) void {
...
pub fn ClearNamedFramebufferfv(framebuffer: uint, buffer: @"enum", drawbuffer: int, values: [*]const float) void {
    return ProcTable.current.?.ClearNamedFramebufferfv(framebuffer, buffer, drawbuffer, values);
}
...
pub fn ClearNamedFramebufferiv(framebuffer: uint, buffer: @"enum", drawbuffer: int, values: [*]const int) void {
    return ProcTable.current.?.ClearNamedFramebufferiv(framebuffer, buffer, drawbuffer, values);
}
pub fn ClearNamedFramebufferuiv(framebuffer: uint, buffer: @"enum", drawbuffer: int, values: [*]const uint) void {
    return ProcTable.current.?.ClearNamedFramebufferuiv(framebuffer, buffer, drawbuffer, values);
}
...
pub fn CreateBuffers(n: sizei, buffers: [*c]uint) void {
    return ProcTable.current.?.CreateBuffers(n, buffers);
}
pub fn CreateFramebuffers(n: sizei, framebuffers: [*c]uint) void {
...
pub fn CreateProgramPipelines(n: sizei, pipelines: [*c]uint) void {
    return ProcTable.current.?.CreateProgramPipelines(n, pipelines);
}
pub fn CreateQueries(target: @"enum", n: sizei, ids: [*c]uint) void {
    return ProcTable.current.?.CreateQueries(target, n, ids);
}
pub fn CreateRenderbuffers(n: sizei, renderbuffers: [*c]uint) void {
    return ProcTable.current.?.CreateRenderbuffers(n, renderbuffers);
}
pub fn CreateSamplers(n: sizei, samplers: [*c]uint) void {
...
pub fn CreateTextures(target: @"enum", n: sizei, textures: [*c]uint) void {
    return ProcTable.current.?.CreateTextures(target, n, textures);
}
pub fn CreateTransformFeedbacks(n: sizei, ids: [*c]uint) void {
    return ProcTable.current.?.CreateTransformFeedbacks(n, ids);
}
pub fn CreateVertexArrays(n: sizei, arrays: [*c]uint) void {
...
pub fn GetActiveAtomicCounterBufferiv(program: uint, bufferIndex: uint, pname: @"enum", params: [*c]int) void {
...
pub fn GetActiveSubroutineName(program: uint, shadertype: @"enum", index: uint, bufSize: sizei, length: [*c]sizei, name: [*c]char) void {
    return ProcTable.current.?.GetActiveSubroutineName(program, shadertype, index, bufSize, length, name);
}
pub fn GetActiveSubroutineUniformiv(program: uint, shadertype: @"enum", index: uint, pname: @"enum", values: [*c]int) void {
    return ProcTable.current.?.GetActiveSubroutineUniformiv(program, shadertype, index, pname, values);
}
pub fn GetActiveSubroutineUniformName(program: uint, shadertype: @"enum", index: uint, bufSize: sizei, length: [*c]sizei, name: [*c]char) void {
...
pub fn GetActiveUniformName(program: uint, uniformIndex: uint, bufSize: sizei, length: [*c]sizei, uniformName: [*c]char) void {
...
pub fn GetBufferSubData(target: @"enum", offset: intptr, size: sizeiptr, data: ?*anyopaque) void {
    return ProcTable.current.?.GetBufferSubData(target, offset, size, data);
}
pub fn GetCompressedTexImage(target: @"enum", level: int, img: ?*anyopaque) void {
    return ProcTable.current.?.GetCompressedTexImage(target, level, img);
}
pub fn GetCompressedTextureImage(texture: uint, level: int, bufSize: sizei, pixels: ?*anyopaque) void {
    return ProcTable.current.?.GetCompressedTextureImage(texture, level, bufSize, pixels);
}
pub fn GetCompressedTextureSubImage(texture: uint, level: int, xoffset: int, yoffset: int, zoffset: int, width: sizei, height: sizei, depth: sizei, bufSize: sizei, pixels: ?*anyopaque) void {
...
pub fn GetInternalformati64v(target: @"enum", internalformat: @"enum", pname: @"enum", count: sizei, params: [*c]int64) void {
...
pub fn GetNamedBufferParameteriv(buffer: uint, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetNamedBufferParameteriv(buffer, pname, params);
}
pub fn GetNamedBufferParameteri64v(buffer: uint, pname: @"enum", params: [*c]int64) void {
    return ProcTable.current.?.GetNamedBufferParameteri64v(buffer, pname, params);
}
pub fn GetNamedBufferPointerv(buffer: uint, pname: @"enum", params: [*c]?*anyopaque) void {
    return ProcTable.current.?.GetNamedBufferPointerv(buffer, pname, params);
}
pub fn GetNamedBufferSubData(buffer: uint, offset: intptr, size: sizeiptr, data: ?*anyopaque) void {
    return ProcTable.current.?.GetNamedBufferSubData(buffer, offset, size, data);
}
pub fn GetNamedFramebufferAttachmentParameteriv(framebuffer: uint, attachment: @"enum", pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetNamedFramebufferAttachmentParameteriv(framebuffer, attachment, pname, params);
}
pub fn GetNamedFramebufferParameteriv(framebuffer: uint, pname: @"enum", param: [*c]int) void {
    return ProcTable.current.?.GetNamedFramebufferParameteriv(framebuffer, pname, param);
}
pub fn GetNamedRenderbufferParameteriv(renderbuffer: uint, pname: @"enum", params: [*c]int) void {
...
pub fn GetProgramStageiv(program: uint, shadertype: @"enum", pname: @"enum", values: [*c]int) void {
...
pub fn GetQueryIndexediv(target: @"enum", index: uint, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetQueryIndexediv(target, index, pname, params);
}
pub fn GetQueryObjectiv(id: uint, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetQueryObjectiv(id, pname, params);
}
pub fn GetQueryObjecti64v(id: uint, pname: @"enum", params: [*c]int64) void {
...
pub fn GetQueryObjectui64v(id: uint, pname: @"enum", params: [*c]uint64) void {
...
pub fn GetTexImage(target: @"enum", level: int, format: @"enum", @"type": @"enum", pixels: ?*anyopaque) void {
...
pub fn GetTextureImage(texture: uint, level: int, format: @"enum", @"type": @"enum", bufSize: sizei, pixels: ?*anyopaque) void {
    return ProcTable.current.?.GetTextureImage(texture, level, format, @"type", bufSize, pixels);
}
pub fn GetTextureLevelParameterfv(texture: uint, level: int, pname: @"enum", params: [*c]float) void {
    return ProcTable.current.?.GetTextureLevelParameterfv(texture, level, pname, params);
}
pub fn GetTextureLevelParameteriv(texture: uint, level: int, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetTextureLevelParameteriv(texture, level, pname, params);
}
pub fn GetTextureParameterfv(texture: uint, pname: @"enum", params: [*c]float) void {
    return ProcTable.current.?.GetTextureParameterfv(texture, pname, params);
}
pub fn GetTextureParameteriv(texture: uint, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetTextureParameteriv(texture, pname, params);
}
pub fn GetTextureParameterIiv(texture: uint, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetTextureParameterIiv(texture, pname, params);
}
pub fn GetTextureParameterIuiv(texture: uint, pname: @"enum", params: [*c]uint) void {
    return ProcTable.current.?.GetTextureParameterIuiv(texture, pname, params);
}
pub fn GetTextureSubImage(texture: uint, level: int, xoffset: int, yoffset: int, zoffset: int, width: sizei, height: sizei, depth: sizei, format: @"enum", @"type": @"enum", bufSize: sizei, pixels: ?*anyopaque) void {
...
pub fn GetTransformFeedbacki_v(xfb: uint, pname: @"enum", index: uint, param: [*c]int) void {
    return ProcTable.current.?.GetTransformFeedbacki_v(xfb, pname, index, param);
}
pub fn GetTransformFeedbackiv(xfb: uint, pname: @"enum", param: [*c]int) void {
...
pub fn GetTransformFeedbacki64_v(xfb: uint, pname: @"enum", index: uint, param: [*c]int64) void {
    return ProcTable.current.?.GetTransformFeedbacki64_v(xfb, pname, index, param);
}
pub fn GetUniformdv(program: uint, location: int, params: [*c]double) void {
...
pub fn GetUniformSubroutineuiv(shadertype: @"enum", location: int, params: [*c]uint) void {
    return ProcTable.current.?.GetUniformSubroutineuiv(shadertype, location, params);
}
pub fn GetVertexArrayiv(vaobj: uint, pname: @"enum", param: [*c]int) void {
    return ProcTable.current.?.GetVertexArrayiv(vaobj, pname, param);
}
pub fn GetVertexArrayIndexediv(vaobj: uint, index: uint, pname: @"enum", param: [*c]int) void {
    return ProcTable.current.?.GetVertexArrayIndexediv(vaobj, index, pname, param);
}
pub fn GetVertexArrayIndexed64iv(vaobj: uint, index: uint, pname: @"enum", param: [*c]int64) void {
    return ProcTable.current.?.GetVertexArrayIndexed64iv(vaobj, index, pname, param);
}
pub fn GetVertexAttribdv(index: uint, pname: @"enum", params: [*c]double) void {
...
pub fn GetVertexAttribLdv(index: uint, pname: @"enum", params: [*c]double) void {
...
pub fn GetnCompressedTexImage(target: @"enum", lod: int, bufSize: sizei, pixels: ?*anyopaque) void {
    return ProcTable.current.?.GetnCompressedTexImage(target, lod, bufSize, pixels);
}
pub fn GetnTexImage(target: @"enum", level: int, format: @"enum", @"type": @"enum", bufSize: sizei, pixels: ?*anyopaque) void {
    return ProcTable.current.?.GetnTexImage(target, level, format, @"type", bufSize, pixels);
}
pub fn GetnUniformdv(program: uint, location: int, bufSize: sizei, params: [*c]double) void {
...
pub fn MapBuffer(target: @"enum", access: @"enum") ?*anyopaque {
...
pub fn MapNamedBuffer(buffer: uint, access: @"enum") ?*anyopaque {
    return ProcTable.current.?.MapNamedBuffer(buffer, access);
}
pub fn MapNamedBufferRange(buffer: uint, offset: intptr, length: sizeiptr, access: bitfield) ?*anyopaque {
...
pub fn MultiDrawArraysIndirectCount(mode: @"enum", indirect: ?*const anyopaque, drawcount: intptr, maxdrawcount: sizei, stride: sizei) void {
    return ProcTable.current.?.MultiDrawArraysIndirectCount(mode, indirect, drawcount, maxdrawcount, stride);
}
pub fn MultiDrawElements(mode: @"enum", count: [*c]const sizei, @"type": @"enum", indices: [*c]const ?*const anyopaque, drawcount: sizei) void {
    return ProcTable.current.?.MultiDrawElements(mode, count, @"type", indices, drawcount);
}
pub fn MultiDrawElementsBaseVertex(mode: @"enum", count: [*c]const sizei, @"type": @"enum", indices: [*c]const ?*const anyopaque, drawcount: sizei, basevertex: [*c]const int) void {
...
pub fn MultiDrawElementsIndirectCount(mode: @"enum", @"type": @"enum", indirect: ?*const anyopaque, drawcount: intptr, maxdrawcount: sizei, stride: sizei) void {
    return ProcTable.current.?.MultiDrawElementsIndirectCount(mode, @"type", indirect, drawcount, maxdrawcount, stride);
}
...
pub fn PolygonOffsetClamp(factor: float, units: float, clamp: float) void {
    return ProcTable.current.?.PolygonOffsetClamp(factor, units, clamp);
}
...
pub fn SpecializeShader(shader: uint, pEntryPoint: [*c]const char, numSpecializationConstants: uint, pConstantIndex: [*c]const uint, pConstantValue: [*c]const uint) void {
    return ProcTable.current.?.SpecializeShader(shader, pEntryPoint, numSpecializationConstants, pConstantIndex, pConstantValue);
}
...
pub fn TextureParameterfv(texture: uint, pname: @"enum", param: [*c]const float) void {
    return ProcTable.current.?.TextureParameterfv(texture, pname, param);
}
...
pub fn TextureParameteriv(texture: uint, pname: @"enum", param: [*c]const int) void {
    return ProcTable.current.?.TextureParameteriv(texture, pname, param);
}
...
pub fn VertexArrayVertexBuffers(vaobj: uint, first: uint, count: sizei, buffers: [*c]const uint, offsets: [*c]const intptr, strides: [*c]const sizei) void {
...
pub fn VertexAttribLPointer(index: uint, size: int, @"type": @"enum", stride: sizei, pointer: usize) void {
...
pub const ProcTable = struct {
    ...
    BindBuffersBase: *const fn (target: @"enum", first: uint, count: sizei, buffers: [*c]const uint) callconv(APIENTRY) void,
    BindBuffersRange: *const fn (target: @"enum", first: uint, count: sizei, buffers: [*c]const uint, offsets: [*c]const intptr, sizes: [*c]const sizeiptr) callconv(APIENTRY) void,
    ...
    BindVertexBuffers: *const fn (first: uint, count: sizei, buffers: [*c]const uint, offsets: [*c]const intptr, strides: [*c]const sizei) callconv(APIENTRY) void,
    ...
    ClearNamedFramebufferfv: *const fn (framebuffer: uint, buffer: @"enum", drawbuffer: int, values: [*]const float) callconv(APIENTRY) void,
    ...
    ClearNamedFramebufferiv: *const fn (framebuffer: uint, buffer: @"enum", drawbuffer: int, values: [*]const int) callconv(APIENTRY) void,
    ClearNamedFramebufferuiv: *const fn (framebuffer: uint, buffer: @"enum", drawbuffer: int, values: [*]const uint) callconv(APIENTRY) void,
    ...
    CreateBuffers: *const fn (n: sizei, buffers: [*c]uint) callconv(APIENTRY) void,
    CreateFramebuffers: *const fn (n: sizei, framebuffers: [*c]uint) callconv(APIENTRY) void,
    CreateProgram: *const fn () callconv(APIENTRY) uint,
    CreateProgramPipelines: *const fn (n: sizei, pipelines: [*c]uint) callconv(APIENTRY) void,
    CreateQueries: *const fn (target: @"enum", n: sizei, ids: [*c]uint) callconv(APIENTRY) void,
    CreateRenderbuffers: *const fn (n: sizei, renderbuffers: [*c]uint) callconv(APIENTRY) void,
    CreateSamplers: *const fn (n: sizei, samplers: [*c]uint) callconv(APIENTRY) void,
    ...
    CreateTextures: *const fn (target: @"enum", n: sizei, textures: [*c]uint) callconv(APIENTRY) void,
    ...
    GetNamedBufferParameteriv: *const fn (buffer: uint, pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    GetNamedBufferParameteri64v: *const fn (buffer: uint, pname: @"enum", params: [*c]int64) callconv(APIENTRY) void,
    GetNamedBufferPointerv: *const fn (buffer: uint, pname: @"enum", params: [*c]?*anyopaque) callconv(APIENTRY) void,
    GetNamedBufferSubData: *const fn (buffer: uint, offset: intptr, size: sizeiptr, data: ?*anyopaque) callconv(APIENTRY) void,
    GetNamedFramebufferAttachmentParameteriv: *const fn (framebuffer: uint, attachment: @"enum", pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    GetNamedFramebufferParameteriv: *const fn (framebuffer: uint, pname: @"enum", param: [*c]int) callconv(APIENTRY) void,
    GetNamedRenderbufferParameteriv: *const fn (renderbuffer: uint, pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    ...
    GetTextureLevelParameterfv: *const fn (texture: uint, level: int, pname: @"enum", params: [*c]float) callconv(APIENTRY) void,
    GetTextureLevelParameteriv: *const fn (texture: uint, level: int, pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    GetTextureParameterfv: *const fn (texture: uint, pname: @"enum", params: [*c]float) callconv(APIENTRY) void,
    GetTextureParameteriv: *const fn (texture: uint, pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    GetTextureParameterIiv: *const fn (texture: uint, pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    GetTextureParameterIuiv: *const fn (texture: uint, pname: @"enum", params: [*c]uint) callconv(APIENTRY) void,
    ...
    GetTransformFeedbacki_v: *const fn (xfb: uint, pname: @"enum", index: uint, param: [*c]int) callconv(APIENTRY) void,
    GetTransformFeedbackiv: *const fn (xfb: uint, pname: @"enum", param: [*c]int) callconv(APIENTRY) void,
    ...
    GetTransformFeedbacki64_v: *const fn (xfb: uint, pname: @"enum", index: uint, param: [*c]int64) callconv(APIENTRY) void,
    ...
    GetVertexArrayiv: *const fn (vaobj: uint, pname: @"enum", param: [*c]int) callconv(APIENTRY) void,
    GetVertexArrayIndexediv: *const fn (vaobj: uint, index: uint, pname: @"enum", param: [*c]int) callconv(APIENTRY) void,
    GetVertexArrayIndexed64iv: *const fn (vaobj: uint, index: uint, pname: @"enum", param: [*c]int64) callconv(APIENTRY) void,
    ...
    GetnCompressedTexImage: *const fn (target: @"enum", lod: int, bufSize: sizei, pixels: ?*anyopaque) callconv(APIENTRY) void,
    GetnTexImage: *const fn (target: @"enum", level: int, format: @"enum", @"type": @"enum", bufSize: sizei, pixels: ?*anyopaque) callconv(APIENTRY) void,
    GetnUniformdv: *const fn (program: uint, location: int, bufSize: sizei, params: [*c]double) callconv(APIENTRY) void,
    ...
    VertexArrayVertexBuffers: *const fn (vaobj: uint, first: uint, count: sizei, buffers: [*c]const uint, offsets: [*c]const intptr, strides: [*c]const sizei) callconv(APIENTRY) void,
